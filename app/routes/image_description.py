...
"""
          # Get the improved description from AI service
        try:
            ai_service = AIService()
            ai_response = ai_service.generate_ai_response_in_json_format(prompt)
            data = json.loads(ai_response)
            # Extract the better version and explanation from AI's response
